(function () {
  ...
  function loadMap(lat, lon) {
    ...
    var map = new kakao.maps.Map(mapContainer, mapOption); //매개변수
    ...
    function searchAddrFromCoords(coords, callback) {
      ...
      //callback: displayCenterInfo(result,status) 함수가있다.
  ...
  function getweather(lat, lon) {
    var urlAPI =
      "https://api.openweathermap.org/data/2.5/weather?appid=0df830d7bf3d8dfc95a581cfbe9440c6&units=metric&lang=kr";
    urlAPI += "&lat=" + lat;
    urlAPI += "&lon=" + lon;
    var temp = {};
    ...
    $.ajax({
      ...
      url: urlAPI,
      dataType: "json",
      async: false, //동기상태 => ajax는 기본적으로 비동기이다. -_-
